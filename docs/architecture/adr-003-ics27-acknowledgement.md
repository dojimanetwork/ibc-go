...
At the time of this writing, Tendermint includes the following information in the [ABCI.ResponseDeliverTx](https://github.com/dojimanetwork/dojimamint/blob/release/v0.34.13/types/results.go#L47-#L53):
```go
