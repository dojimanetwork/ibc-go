...
// source: ibc/lightclients/dojimamint/v1/dojimamint.proto
...
import (
	...
	types2 "github.com/dojimanetwork/dojimamint/proto/dojimamint/types"
...
type ConsensusState struct {
	...
	NextValidatorsHash github_com_tendermint_tendermint_libs_bytes.HexBytes `protobuf:"bytes,3,opt,name=next_validators_hash,json=nextValidatorsHash,proto3,casttype=github.com/dojimanetwork/dojimamint/libs/bytes.HexBytes" json:"next_validators_hash,omitempty" yaml:"next_validators_hash"`
}
...
func init() {
	proto.RegisterType((*ClientState)(nil), "ibc.lightclients.dojimamint.v1.ClientState")
	proto.RegisterType((*ConsensusState)(nil), "ibc.lightclients.dojimamint.v1.ConsensusState")
	proto.RegisterType((*Misbehaviour)(nil), "ibc.lightclients.dojimamint.v1.Misbehaviour")
	proto.RegisterType((*Header)(nil), "ibc.lightclients.dojimamint.v1.Header")
	proto.RegisterType((*Fraction)(nil), "ibc.lightclients.dojimamint.v1.Fraction")
}

func init() {
	proto.RegisterFile("ibc/lightclients/dojimamint/v1/dojimamint.proto", fileDescriptor_c6d6cf2b288949be)
}
